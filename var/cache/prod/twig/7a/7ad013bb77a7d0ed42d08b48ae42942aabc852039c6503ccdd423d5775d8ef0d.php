...
/* 1.0/plugins/recordplay/recordplay.js */
class __TwigTemplate_dc5da93e7cf01bf7d8f0870de53f5c4a41819c8fccd85db0aec3ce7485c27fbc extends Twig_Template
{
    ...
    {
        // line 1
        echo "﻿// use this to isolate the scope
(function() {
...
//            recordPlayUi += 'cursor: ' + eventObject.eventInfo.cursor.x + ',' + eventObject.eventInfo.cursor.y + '<br/>';
    ...
    {
        return "1.0/plugins/recordplay/recordplay.js";
    }
    ...
    {
        return new Twig_Source("", "1.0/plugins/recordplay/recordplay.js", "/home/alex/repository/WowChecker/app/Resources/views/1.0/plugins/recordplay/recordplay.js");
    }
}
